...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  outline: 'border border-line bg-surface text-ink hover:bg-gray-100 focus-visible:ring-primary-500',
  ghost: 'bg-transparent text-ink hover:bg-gray-100 focus-visible:ring-primary-500',
