  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-muted">Find answers to common questions or get in touch with our support team</p>
      </div>
      ...
      <Card>
        <CardHeader>
          <h2 className="text-lg font-medium text-ink">Frequently Asked Questions</h2>
        </CardHeader>
        <CardBody>
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <div key={index} className="border-b border-line last:border-0 pb-6 last:pb-0">
